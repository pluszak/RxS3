...
public class UTF8UrlEncoder {
	...
	public static String encode(String input) {
		TextBuilder sb = new TextBuilder(input.length() + 16);
		appendEncoded(sb, input, 0);
		return sb.toString();
	}

	public static TextBuilder appendEncoded(TextBuilder sb, String input) {
		return appendEncoded(sb, input, 0);
	}

	public static TextBuilder appendEncoded(TextBuilder sb, String input, int offset) {
