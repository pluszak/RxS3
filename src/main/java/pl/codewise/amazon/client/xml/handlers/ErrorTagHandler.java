...
public enum ErrorTagHandler implements TagHandler<AmazonS3ExceptionBuilder> {
	...
	ERROR("Error") {
		...
		@Override
		public void handleText(AmazonS3ExceptionBuilder exception, XmlPullParser parser, LinkedList<? extends TagHandler<AmazonS3ExceptionBuilder>> handlerStack) {
	...
	public void handleText(AmazonS3ExceptionBuilder objectListing, XmlPullParser parser, LinkedList<? extends TagHandler<AmazonS3ExceptionBuilder>> handlerStack) {
	}
